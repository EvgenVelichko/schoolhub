...
export function NotificationBell() {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="end"
        className="w-80 glass-panel border-white/10 rounded-2xl p-0 z-[150] max-h-[70vh] overflow-hidden flex flex-col"
      >
                  ...
                  <div className="min-w-0 flex-1">
                    <p
                      className={cn(
                        ...
                        notif.isRead ? "text-muted-foreground" : "text-white",
                      )}
                    >
                      {notif.title}
                    </p>
